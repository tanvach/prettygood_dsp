...
appstartaddr    = 0x00002000 # SAMD21 flash
familyid        = 0x68ed2b88 # SAMD21 selected
...
# Adapted from WizIO 2021 Georgi Angelov
#   http://www.wizio.eu/
#   https://github.com/Wiz-IO/wizio-pico


def convert(target, source, env):
    bin_name = ".pio/build/adafruit_qt_py_m0/firmware.bin"
    uf2_name = "firmware.uf2"
    print("\nConverting to UF2")
...
Import("env", "projenv")
# env.AddPostAction(".pio/build/adafruit_qt_py_m0/firmware.bin", convert)
env.AddPostAction("$BUILD_DIR/${PROGNAME}.bin", convert)
